---
slug: narrative-in-ai-era
title: "当生成变得廉价，\n叙事为什么更重要"
description: '当模型可以低成本生成内容，清楚地描述问题、展示思考过程的能力反而更稀缺。'
date: 2026-04-19
category: thinking
categoryLabel: 思考
cardExcerpt: 能把模糊的问题讲清楚，不只是表达能力；它决定了我们如何学习、如何与 AI 协作。
kicker: 思考 · AI 协作
deck: 模型能替我写出很多句子，却不能替我决定：这个问题到底是什么、为什么值得解决、下一步该往哪里问。
cover: /assets/blog/narrative-cover.png
coverAlt: 深蓝夜城中一条金色轨迹连接散落的纸片
coverCaption: 表达不是包装，而是让思考显形的过程。
readTime: 6
author: Hongyu
published: true
previousUrl: ai-to-understanding.html
previousLabel: ← 把 AI 的答案变成自己的理解
nextUrl: token-addiction.html
nextLabel: 下一篇：我为什么会对 Token 上瘾 →
---
...
<div class="post-aside"><strong>一个小练习：</strong>下次向 AI 提要求前，先写下「我观察到什么」「我想改变什么」「什么结果算成功」。这三句话，就是叙事的最小单位。</div>

## 把自己的路径讲出来

生成工具会越来越好，这大概不会改变。但人的经验、取舍和正在形成中的理解，仍然无法被批量生产。它们也许不够完美，却能让另一个人少走一点弯路。

<p class="post-endmark">当生成变得廉价，真正稀缺的不是内容，而是有来处的判断。</p>
